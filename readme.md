...
virt-customize -a $IMAGE --run-command 'dnf --enablerepo=elrepo-kernel install -y kernel-lt --allowerasing'
virt-customize -a $IMAGE --run-command 'dnf --enablerepo=elrepo-kernel install -y kernel-lt-modules-extra --allowerasing'
